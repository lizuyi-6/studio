...
const team = [
  {
    ...
    social: { linkedin: '#', email: 'abraham@aether.io', github: 'https://github.com/lizuyi-6' },
  },
  {
    name: '林雅婷',
    role: '技术总监',
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <button onClick={onBack} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <span className="text-white font-semibold text-lg tracking-tight">Aether</span>
          </button>
  ...
  <section id="team" className="py-24 lg:py-32 bg-black border-t border-white/5">
    <div className="max-w-7xl mx-auto px-6 lg:px-8">
      <motion.div {...fadeInUp} className="text-center max-w-2xl mx-auto mb-16">
        <div className="flex items-center justify-center gap-3 mb-4">
          <span className="w-8 h-px bg-[#0066FF]" />
          <span className="text-[#0066FF] text-sm font-medium">核心团队</span>
          <span className="w-8 h-px bg-[#0066FF]" />
        </div>
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">
          认识我们的<span className="text-[#0066FF]">团队</span>
        </h2>
        <p className="text-lg text-white/60">由资深工程师、设计师和产品专家组成的专业团队</p>
      </motion.div>

      <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once: true }} className="grid md:grid-cols-3 gap-8 mb-20">
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-6">
                <div className="flex gap-3">
                  {member.social.linkedin && (
                    <a href={member.social.linkedin} className="w-10 h-10 bg-white/10 flex items-center justify-center hover:bg-[#0066FF] transition-colors">
                      <Linkedin className="w-4 h-4 text-white" />
                    </a>
                  )}
                  {member.social.email && (
                    <a href={`mailto:${member.social.email}`} className="w-10 h-10 bg-white/10 flex items-center justify-center hover:bg-[#0066FF] transition-colors">
                      <Mail className="w-4 h-4 text-white" />
                    </a>
                  )}
                  {member.social.github && (
                    <a href={member.social.github} className="w-10 h-10 bg-white/10 flex items-center justify-center hover:bg-[#0066FF] transition-colors">
    ...
    <footer className="bg-black border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-white font-semibold text-lg">Aether</span>
            </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-sm">© 2026 Aether Studio. All rights reserved.</p>
